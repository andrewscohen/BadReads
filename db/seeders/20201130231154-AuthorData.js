...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Authors', [
      ...
      { name: 'F. Scott Fitzgerald', createdAt: new Date(), updatedAt: new Date() },
      { name: 'John Gardner', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Justin Bieber', createdAt: new Date(), updatedAt: new Date() },
      { name: 'Nicole "Snooki" Polizzi', createdAt: new Date(), updatedAt: new Date() },
      ...
      { name: 'Christopher Perch', createdAt: new Date(), updatedAt: new Date() },
